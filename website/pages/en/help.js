...
class Help extends React.Component {
  render() {
    const supportLinks = [
      {
        content: 'Learn more using the [documentation on this site.](/SpRestLib/docs/installation.html)',
        title: 'Browse Docs',
      },
      {
      ...
      {
        content: "Look through the categorized [project issues](https://gitbrent.github.io/sprestlib/issues) for a solution",
        title: 'View Issues',
      },
    ];
      ...
      <div className="docMainWrapper wrapper">
        <Container className="mainContainer documentContainer postContainer">
          <div className="post">
			...
			<ul>
				<li>Use Ask Question on <a href="http://stackoverflow.com/">StackOverflow</a> - be sure to tag it with "SpRestLib"</li>
			</ul>
